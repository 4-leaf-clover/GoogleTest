...
public class VoiceRecorder {
    ...
    public static abstract class Callback {
        ...
        public void onVoiceStart() {
            Log.d("STT","Voice has started recording");
        }
        ...
        public void onVoiceEnd() {
            Log.d("STT","Voice has finished recording");
        }
    }
    ...
    public void start() {
        ...
        Log.d("STT","VoiceRecorder class start");
        // Start processing the captured audio.
        mThread = new Thread(new ProcessVoice());
        mThread.start();
        Log.d("STT","VoiceRecorder class start Thread");
    }
     ...
     */
    public void stop() {
        Log.d("STT","VoiceRecorder class stop");
        synchronized (mLock) {
            dismiss();
            if (mThread != null) {
                mThread.interrupt();
